...
clear
REPO="https://raw.githubusercontent.com/RolkosModai/premium/main/"
start=$(date +%s)
secs_to_human() {
...
wget -q https://raw.githubusercontent.com/RolkosModai/premium/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
